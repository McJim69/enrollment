			...
			while($rss = mysqli_fetch_array($exs)){	
				...
				<div class='row'>
					...
					<div class='col col-md-6'>	
						...
						<div class='form-control mar-top'>Semester: <b>".$rss['SEMESTER']." Semester</b></div>
					...
					<div class='col col-md-3'>	
						...
						<div class='form-control mar-top'>Class Block: <b>";
							if($rss['CLASS_BLOCK']==""){echo"Not Yet";} else {echo"".$rss['CLASS_BLOCK']."";}echo"</b>
						</div>							
				...
				<div class='row text-center'>
					...
					<div id='buttons2' class='col col-md-4'>
						...
						<div class='row text-center'>
							...
							<button class='btn btn-primary' onclick=\"jump('editStudent.php?id=$rss[0]')\"  style='width:100px'>Edit</button>
						</div>
					</div>
				</div>";
			}
