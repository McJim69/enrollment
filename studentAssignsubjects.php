...
<div class="container">
	...
	?>
		<div class="well">
			    <form action="studentSubjects_p.php?id=<?php echo $sID; ?>&SY=<?php echo $_GET['SY']; ?>" Method="POST">  					
				<table class="table table-hover">
				  ...
				  <tfoot>
					...
					if ($pagination->total_pages() > 1){
						...
						if ($current_page == 1 ){
							echo ' <li class="disabled"><a href=?id='.$sID.'&page='.$pagination->First_page().'>First </a> </li>';
						
						}else{
							echo ' <li ><a href=?id='.$sID.'&page='.$pagination->First_page().'>First </a> </li>';

						}
						
						if  ($current_page >= 1 ){
							
							echo ' <li> <a href=?id='.$sID.'&page='.($current_page - 1).'>Previous </a> </li>';

						}else{
							echo ' <li class="disabled"> <a href=?id='.$sID.'&page='.($current_page - 1).'>Previous </a> </li>';
						}
						
						if ($current_page <  $pagination->total_pages()){
						
							echo ' <li><a href=?id='.$sID.'&page='.($current_page + 1) .'>Next</a></li> ';
											
						}else{

							echo ' <li class="disabled"><a href=?id='.$sID.'&page='.($current_page + 1) .'>Next</a></li> ';
						}
						...
						if ($current_page ==  $pagination->total_pages() ){
							...
							echo ' <li class="disabled"><a href=?id='.$sID.'&page='.$pagination->total_pages().'>Last </a> </li>';
						}else{
							echo ' <li><a href=?id='.$sID.'&page='.$pagination->total_pages().'>Last </a> </li>';
						}
				...
				<div class="btn-group">
				  <a href="studentView.php?id=<?php echo (isset($sID)) ? $sID : 'ID' ;?>" class="btn btn-default"><span class="glyphicon glyphicon-back"></span>Back</a>
