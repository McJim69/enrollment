<?php
	...
	$qrs = $conn->query("SELECT * FROM tblstudent s WHERE s.S_ID='".$ID."'");
	$res = $qrs->fetch_array();
	$sID = $res[0];
...
<div class="container">
	<form class="form-horizontal well span9" action="editStudent_proc.php?id=<?php echo $sID;?>" method="POST">
	<!--Primary Details-->
		<fieldset><legend>COLLEGE ENROLLMENT FORM  <?php echo $res['LNAME'];?>, <?php echo $res['FNAME'];?> <?php echo $res['MNAME'];?></legend></fieldset>				
			<div class="row" style="margin:-10px 0 0 0">
				...
				<div class="col-md-2"><b>&nbsp;Class Block</b>
					<select class="form-control input-sm" name="block" required>
						<option value="<?php echo $res['CLASS_BLOCK'];?>">Block <?php echo $res['CLASS_BLOCK'];?></option>
		...
		<fieldset><legend>Personal Information</legend>	
			...
			<div class="form-group">
				...
				<div class="col-md-4"><label class="col-md-4 control-label">Email</label>
					<div class="col-md-8">
						<input class="form-control input-sm" name="sEmail" placeholder="Email Address" value="<?php echo $res['EMAIL'];?>" readonly style="background:#fff">
					</div>
				</div>
