...
<div id="footer" style="position:fixed; bottom:0;right:0;left:0;width:100%;background:#313131;padding:10px; 0 10px 0">
	<footer style="color:#bbb">
        <div align="center">
			<a href="https://www.facebook.com/WestPrimeOfficial" target="_blank">
				West Prime Horizon Institute, Inc </a> | 
				Powered by <a href="https://www.mcjim-server.net" target="_blank">McJim Cyberworks</a> |
				Project by Team <a href="https://www.facebook.com/janeth.pepito.5" target="_blank">
				Janeth Pepito
			</a> 
		</div>
