...
<div class="rows">
	<div class="col-12 col-sm-12 col-lg-12">
		...
		<?php
			...
			$NumberofResult = $Schoolyr->findsy($sID);
		
			$sy = $Schoolyr->single_sy($sID);
			$course = new Course();
			$studcourse = $course->single_course($sy->COURSE_ID);
			//the button in assigning the subjects.
			$button ='<a href = "studentAssignsubjects.php?studentId='.$sID.'&SY='.$sy->AY.'" class="btn btn-default"><span class="glyphicon glyphicon-plus-sign"></span>Assign Subject</a>
			<button type="submit" class="btn btn-default" name="delete"> &nbsp; <span class="glyphicon glyphicon-trash"></span> Delete Selected</button>';
			$student = new Student();
			$cur = $student->single_student($sID);
		?>
		  ...
		  <!-- <form class="form-horizontal span4" action="#.php" method="POST"> -->
				...
				<div class="container">
					...
					?>
				 <div class="well">
				<form class="form-horizontal span4" action="studentDeletesubjects.php?sID=<?php echo $sID; ?>" method="POST">					    
				  <table class="table table-hover">
					<caption><h3 align="left">Subjects</h3><hr/></caption>
					  ...
					  <!-- 	<tr><td colspan="2">Date Printed:  <? //print(Date("l F d, Y")); ?> .</td><td colspan="2">Advised and signed by:</td><td ></td></tr>  -->
						...
						<div class="btn-group">
						<a href="studentView.php" class="btn btn-default">  Back</a>
						<?php echo (isset($button)) ? $button : ''; ?>
			 				<!-- <a href = "assignstudentsubjects.php?studentId=<?php // echo (isset($sID)) ? $sID : 'ID' ; ?>" class="btn btn-default"><span class="glyphicon glyphicon-plus-sign"></span>Assign Subject</a> -->
					  <!--  <button type="submit" class="btn btn-default" name="delete"><span class="glyphicon glyphicon-trash"></span> Delete Selected</button> -->
					</form>
						</body>
						</html>		
