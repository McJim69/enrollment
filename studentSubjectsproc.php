			...
			$sID = $str['IDNO']; 
				...
				$Schoolyr = new Schoolyr();
					...
					if ($NumberofResult == 0){
						...
						// check_message();
 						redirect("studentView.php?id=".$sID);
						...
						$button ='<a href = "assignstudentsubjects.php?$sID='.$sID.'&SY='.$sy->AY.'" class="btn btn-default"><span class="glyphicon glyphicon-plus-sign"></span>Assign Subject</a>
  ...
  ?>
		  ...
		  <!-- <form class="form-horizontal span4" action="#.php" method="POST"> -->
				...
				<div class="container">
					...
					?>
				 <div class="well">
				<form class="form-horizontal span4" action="delete_studentSubjects.php?$sID=<?php echo $sID; ?>" method="POST">					    
					...
					<caption><h3 align="left">Subjects</h3><hr/></caption>
					  ...
					  <!-- 	<tr><td colspan="2">Date Printed:  <? //print(Date("l F d, Y")); ?> .</td><td colspan="2">Advised and signed by:</td><td ></td></tr>  -->
						...
						<?php echo (isset($button)) ? $button : ''; ?>
			 				<!-- <a href = "assignstudentsubjects.php?$sID=<?php // echo (isset($sID)) ? $sID : 'ID' ; ?>" class="btn btn-default"><span class="glyphicon glyphicon-plus-sign"></span>Assign Subject</a> -->
					  <!--  <button type="submit" class="btn btn-default" name="delete"><span class="glyphicon glyphicon-trash"></span> Delete Selected</button> -->
					</form>
						</body>
						</html>		
